...
The delegation of every appearance to [Theming](../theming/) and the aligned cells and headers in [Select Request](#select-request), [Filtering](#filtering), and [Presentation](#presentation) are **not yet implemented**. [Change 0026](../../changes/0026-add-theme-variables.md) and [Change 0027](../../changes/0027-add-multi-cell-select-rows.md) implement them in that order.
